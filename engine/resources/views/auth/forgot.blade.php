...
<head>
	...
	<title>Lupa Password | SISTAMAS</title>
		...
		<main class="container-fluid">
			<div class="login-wrapper row">
				<div class="login-l col-lg-4">			
                    ...
                    <form action="{{ url('reset_pass') }}" class="login-form" autocomplete="on" method="post">
						@csrf
						<a href="{{ url('/') }}"><img src="{{ asset('assets-front') }}/images/logo.png" width="200px" alt="logo"></a>

						<p>Masukan Email anda untuk mengubah password</p>
						<div class="txtb">
						...
						<div class="txtb">
							...
							<span data-placeholder="Password Baru"></span>
						</div>
						<div class="txtb">
							<input type="password" required="" name="password_confirmation">
							<span data-placeholder="Konfirmasi Password Baru"></span>
						</div>

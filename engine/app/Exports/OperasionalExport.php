...
class OperasionalExport implements FromView, ShouldAutoSize, WithEvents
{
    use Exportable;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $akun = $akun->whereRaw('LENGTH(kode) < 8')->where('kode', 'LIKE' , "4%")->where('kode', 'LIKE' , "5%")->orderBy('kode');

...
class PenerimaanController extends Controller
{
    public function index()
    {
        ...
        return view('admin.anggaran.penerimaan', compact('anggaran','akun', 'masjid'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('anggaran.penerimaan.index')->with('info', 'Data ' . $request->deskripsi .' berhasil diupdate');
        } catch (\Throwable $th) {
            return redirect()->back()->with('error','Server error,'.$th->getMessage());
        }
